...
class TestApp(EWrapper, EClient):
    ...
    def historicalData(self, reqId, bar):
        ...
        acct_dict = {"HistoricalData. ", reqId, " Date:", bar.date, "Open:", bar.open,"High:", bar.high, "Low:", bar.low, "Close:", bar.close, "Volume:", bar.volume,"Count:", bar.barCount, "WAP:", bar.average}
        print(acct_dict)
